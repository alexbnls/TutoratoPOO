...
public class SkiCourse implements Course{
    private String id;
    private int numPartecipanti;
    private GregorianCalendar dataInizio;
    private int durataCorso;
    private final static int minPartecipanti = 4;
    private final static int maxPartecipanti = 8;

    public SkiCourse(String id, int numPartecipanti, GregorianCalendar dataInizio, int durataCorso) {
        if(durataCorso < 0)
